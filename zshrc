...
export ZSH=/home/mckenna/.oh-my-zsh
...
alias rpi="ssh pi@192.168.1.28"
alias osuvpn="sudo openconnect sds.oregonstate.edu"

# Utilities
alias pdf='function _pdf(){ evince $1 </dev/null &>/dev/null & };_pdf'
...
# nvm path
export NVM_DIR="/home/mckenna/.nvm"
# This loads nvm but it also is slow as fuck
#[ -s "$NVM_DIR/nvm.sh" ] && \. "$NVM_DIR/nvm.sh"

alias weather="curl http://wttr.in/corvallis"
